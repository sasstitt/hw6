...
window.addEventListener('DOMContentLoaded', async function(event) {
    ...
    let URL = 'https://api.themoviedb.org/3/movie/now_playing?api_key=62ecafa0d19d5d34a729aa015b7ac05a&language=en-US'
    ...
    for(let i=0; i<movies.length; i++){
        ...
        document.querySelector('.movies').insertAdjacentHTML('beforeend', `<div class="movies-${movieID} w-1/5 p-4 opacity-20"> 
    ...
    // ⬇️ ⬇️ ⬇️
        ...
        document.querySelector(`.movies-${movieID}`).addEventListener('click', async function(event){
            ...
            let clicked = document.querySelector(`.movies-${movieID}`)
